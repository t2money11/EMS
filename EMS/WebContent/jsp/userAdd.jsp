...
<sf:form id="form1" method="post" action="/EMS/user/add" modelAttribute="user">
				...
				<table class="table">
					<tbody>
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="userId" maxlength="30"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="userNameC" maxlength="30"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="userNameE" maxlength="30"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="contractPeriod" maxlength="30"/>
							</td>
						</tr>
						<tr>
							<th class="iobox-label-area additional va-m" style="width: 140px;">
							...
							<td>
								<sf:select class="w300" path="category" items="${user.categoryInput}"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="mail" maxlength="30"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:select class="w300" path="gender" items="${user.genderInput}"/>
							</td>
							<th class="iobox-label-area additional va-m" style="width: 140px;">
								生日
							</th>
							<td>
								<sf:input class="span4 control-largeCommon" path="birthday" maxlength="10" onfocus="WdatePicker()"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:select class="w300" path="highestEducation" items="${user.highestEducationInput}"/>
							</td>
							<th class="iobox-label-area additional va-m" style="width: 140px;">
								职位
							</th>
							<td>
								<sf:input class="span4 control-largeCommon" path="position" maxlength="30"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="onboardDate" maxlength="10" onfocus="WdatePicker()"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="seperateDate" maxlength="10" onfocus="WdatePicker()"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:select class="w300" path="vacation" items="${user.vacationInput}"/>
							</td>
							<th class="iobox-label-area additional va-m" style="width: 140px;">
								人事关系
							</th>
							<td>
								<sf:input class="span4 control-largeCommon" path="humanRelations" maxlength="30"/>
							</td>
						</tr>
						<tr>
							<th class="iobox-label-area additional va-m" style="width: 140px;">
							...
							<c:choose>
								<c:when test="${sessionScope.loginUser.category eq '1'}">
									<td>
										<sf:input class="span4 control-largeCommon" path="salary" maxlength="30"/>
										<br/>
							...
							<c:choose>
								<c:when test="${sessionScope.loginUser.category eq '1'}">
									<td>
										<sf:input class="span4 control-largeCommon" path="welfare" maxlength="30"/>
									</td>
								</c:when>
								<c:otherwise>
									<td>
