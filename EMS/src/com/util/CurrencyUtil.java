...
public class CurrencyUtil {  
    ...
    public static void main(String[] args) {  
        System.out.println(CurrencyUtil.transferMoneyToWord("10.12"));  
//        System.out.println(obj.transferMoneyToWord("12.12"));  
//        System.out.println(obj.transferMoneyToWord("123.12"));  
//        System.out.println(obj.transferMoneyToWord("1234.12"));  
//        System.out.println(obj.transferMoneyToWord("12345.12"));  
//        System.out.println(obj.transferMoneyToWord("123456.12"));  
//        System.out.println(obj.transferMoneyToWord("1234567.12"));  
//        System.out.println(obj.transferMoneyToWord("12345678.12"));  
//        System.out.println(obj.transferMoneyToWord("0.14"));  
//        System.out.println(obj.transferMoneyToWord("35556083.01"));  
    }  
      
    public static String transferMoneyToWord(String x){
		...
		if (!"".equals(lm)) {
			...
			if(!" ".equals(lm.substring(lm.length() - 1, lm.length()))){
				lm = lm + " ";
			}
			if (Integer.parseInt(lstr) == 1) {
		...
		if (z > -1) {
			...
			if (!"".equals(lm)) {
				...
				xs = transTwo(rstr) + " CENTS"; // 小数部分存在时转换小数
			}
		}
