...
<sf:form id="form1" method="post" action="/EMS/production/add" modelAttribute="production">
				...
				<table class="table">
					<tbody>
						<tr>
							...
							<td colspan="3">
								<sf:input class="span6 control-largeCommon" path="productionId" maxlength="45"/>
								-----
				...
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td>
								<c:choose>
								<c:when test="${sessionScope.loginUser.category == '1' || sessionScope.loginUser.category == '3'}">
