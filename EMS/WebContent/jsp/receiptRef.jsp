...
<input type="hidden" name="pageMode" value="ref"/>
				...
				<table class="table">
					<tbody>
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="receiptDate" maxlength="10" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td colspan="3">
								<sf:input class="span4 control-largeCommon" path="receiptNo" maxlength="30" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td colspan="3">
								<sf:input class="span4 control-largeCommon" path="relateReceiptNo" maxlength="30" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td colspan="3">
								<sf:input class="span4 control-largeCommon" path="balanceDate" maxlength="30" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td colspan="3">
								...
								<sf:hidden path="customerFullName"/>
								<sf:hidden path="paymentTerms"/>
								<sf:hidden path="portOfLoading"/>
								<sf:hidden path="portOfDestination"/>
								<sf:hidden path="consignee"/>
								<sf:hidden path="contact"/>
							</td>
						</tr>
						<tr>
							<th class="iobox-label-area additional va-m" style="width: 140px;">
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="mark" maxlength="30" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="ETD" maxlength="10" readonly="true"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="ETA" maxlength="10" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="remint" maxlength="30" readonly="true"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="goodTime" maxlength="10" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="planPostingDate" maxlength="10" readonly="true"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="postingDate" maxlength="10" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="telexRelease" maxlength="10" readonly="true"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="transportation" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="checkoutNumber" maxlength="30" readonly="true"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="profit" maxlength="30" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="postingTo" maxlength="30" readonly="true"/>
								<br/>
							...
							<td>
								<sf:input class="span4 control-largeCommon" path="postingAmount" maxlength="30" readonly="true"/>
								<br/>
						...
						<tr>
							...
							<td colspan="3">
								<sf:radiobutton path="receiptMode" value="1" checked="true" disabled="true"/>需要报关
								<sf:radiobutton style="margin-left: 10px" path="receiptMode" value="0" disabled="true"/>不需要报关
							</td>
							<sf:hidden path="receiptMode"/>
						</tr>
					</tbody>
				</table>
			</div>
								...
								<tbody>
									<tr>
										...
										<td>
											...
											<sf:hidden path="receiptDtlList[${status.index}].brand"/>
											<sf:hidden path="receiptDtlList[${status.index}].purpose"/>
											<sf:hidden path="receiptDtlList[${status.index}].material"/>
											<sf:hidden path="receiptDtlList[${status.index}].kind"/>
											<sf:hidden path="receiptDtlList[${status.index}].kindName"/>
											<sf:hidden path="receiptDtlList[${status.index}].boxAmount"/>
											<sf:hidden path="receiptDtlList[${status.index}].advancePayment"/>
											<sf:hidden path="receiptDtlList[${status.index}].advancePaymentDate"/>
											<sf:hidden path="receiptDtlList[${status.index}].advancePaymentDiscountRate"/>
											<sf:hidden path="receiptDtlList[${status.index}].exRate"/>
										</td>
										<td>
										...
										<td>
											<sf:input class="control-largeCommon" path="receiptDtlList[${status.index}].quantity" maxlength="7" style="width:80px" readonly="true"/>
								...
								<tbody>
									<tr>
										...
										<td>
											...
											<sf:hidden path="receiptDtl4CList[${status.index}].brand"/>
											<sf:hidden path="receiptDtl4CList[${status.index}].purpose"/>
											<sf:hidden path="receiptDtl4CList[${status.index}].material"/>
											<sf:hidden path="receiptDtl4CList[${status.index}].kind"/>
											<sf:hidden path="receiptDtl4CList[${status.index}].kindName"/>
										...
										<td>
											<sf:input class="control-largeCommon" path="receiptDtl4CList[${status.index}].quantity" maxlength="7" style="width:80px" readonly="true"/>
					...
					<table class="table table-striped  table-bordered" id="tab1">
							...
							<tbody>
								<tr>
									<td>
										...
										<sf:hidden path="clearanceDtlList[${status.index}].hscode"/>
									...
									<td>
										${item.unitPrice!=null?item.unitPrice:'&nbsp;'}<br/>
										<sf:hidden path="clearanceDtlList[${status.index}].unitPrice"/>
									</td>
									<td>
									...
									<td>
										${item.amount!=null?item.amount:'&nbsp;'}<br/>
										<sf:hidden path="clearanceDtlList[${status.index}].amount"/>
									</td>
									<td>
						...
						<tbody>
							<tr>
								...
								<td>
									<sf:input class="control-largeCommon" path="amountTtl4Export" maxlength="11" style="width:130px;margin-left:-5px;margin-bottom:-7px;margin-top:-6px" readonly="true"/>
