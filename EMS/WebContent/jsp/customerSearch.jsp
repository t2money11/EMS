		...
		<div class="titledbox-body titledbox-body-extended">
			...
			<div class="form-actions ta-c">
				...
				<c:if test="${sessionScope.loginUser.category == '1' || sessionScope.loginUser.category == '2'}">
					<a style="margin-left:30px;" class="btn btn-primary w100" id="customerAdd">
						<b>
							添加
						</b>
					</a>
			...
			<div id="result" class="datagrid">
				<table class="table table-striped  table-bordered" style="">
					...
					<c:forEach var="item" items="${customer.resultCustomerList}" varStatus="status">
						<tr>
							<td class="va-m ta-c">
								<input type="radio" name="itemSelected" customerId="${item.customerId}"/>
							</td>
							<td>
				...
				<div class="bulk-editing-area dividingbox dividingbox-jointed">
					<div class="row-fluid">
						<div class="span12 ta-c">
							<a class="btn btn-primary w100" id="customerRef" href="javascript:void(0);">
								<b>
									查看
								</b>
							</a>
						 	<c:if test="${sessionScope.loginUser.category == '1' || sessionScope.loginUser.category == '2'}">
								<a style="margin-left:30px;" class="btn btn-primary w100" id="customerCopy" href="javascript:void(0);">
									<b>
										复制
									</b>
								</a>
						 	...
						 	<c:if test="${sessionScope.loginUser.category == '1' || sessionScope.loginUser.category == '2' || sessionScope.loginUser.category == '5'}">
								<a style="margin-left:30px;" class="btn btn-primary w100" id="customerUpdate" href="javascript:void(0);">
									<b>
										修改
									</b>
								</a>
								<a style="margin-left:30px;" id="customerDelete" class="btn w100" href="javascript:void(0);">
									<b>
										删除
									</b>
								</a>
