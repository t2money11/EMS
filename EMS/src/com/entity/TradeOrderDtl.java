...
public class TradeOrderDtl extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 6578586384932163734L;
	...
	private String countComplaintDtl;
	
	private String lastComplaintDate;
	private String lastDrawUpdateDate;
	
	public String getCountComplaintDtl() {
		return StringHandler.format(countComplaintDtl);
	}
	public void setCountComplaintDtl(String countComplaintDtl) {
		this.countComplaintDtl = countComplaintDtl;
	}
