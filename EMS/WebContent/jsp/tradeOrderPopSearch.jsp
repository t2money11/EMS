			...
			for (i=0; i<tradeOrderPopList.length; i++)
			{
			    if (tradeOrderPopList[i].checked)
			    {
			        var temp = {
						...
						shortLocation:tradeOrderPopList[i].getAttribute("shortLocation"),
						...
						iQuantity:tradeOrderPopList[i].getAttribute("iQuantity"),
						iUnitPrice:tradeOrderPopList[i].getAttribute("iUnitPrice"),
						iQuantityNotSent:tradeOrderPopList[i].getAttribute("iQuantityNotSent"),
						...
						tFeeTitle1:tradeOrderPopList[i].getAttribute("tFeeTitle1"),
						tFee1:tradeOrderPopList[i].getAttribute("tFee1"),
						tFeeTitle2:tradeOrderPopList[i].getAttribute("tFeeTitle2"),
						tFee2:tradeOrderPopList[i].getAttribute("tFee2"),
						tFeeTitle3:tradeOrderPopList[i].getAttribute("tFeeTitle3"),
						tFee3:tradeOrderPopList[i].getAttribute("tFee3"),
						tFeeTitle4:tradeOrderPopList[i].getAttribute("tFeeTitle4"),
						tFee4:tradeOrderPopList[i].getAttribute("tFee4"),
						iFeeTitle1:tradeOrderPopList[i].getAttribute("iFeeTitle1"),
						iFee1:tradeOrderPopList[i].getAttribute("iFee1"),
						iFeeTitle2:tradeOrderPopList[i].getAttribute("iFeeTitle2"),
						iFee2:tradeOrderPopList[i].getAttribute("iFee2"),
						iFeeTitle3:tradeOrderPopList[i].getAttribute("iFeeTitle3"),
						iFee3:tradeOrderPopList[i].getAttribute("iFee3"),
						iFeeTitle4:tradeOrderPopList[i].getAttribute("iFeeTitle4"),
						iFee4:tradeOrderPopList[i].getAttribute("iFee4")
			        };
...
<script src="../jsp/js/tradeOrderPop.js"></script>
						...
						<tr>
							<td class="va-m ta-c">
								<c:if test="${item.volume != null
									...
									shortLocation="${fn:escapeXml(item.shortLocation)}"
									...
									iQuantity="${fn:escapeXml(item.iQuantity)}"
									iUnitPrice="${fn:escapeXml(item.iUnitPrice)}"
									iQuantityNotSent="${fn:escapeXml(item.iQuantityNotSent)}"
									...
									tFeeTitle1="${fn:escapeXml(item.tFeeTitle1)}"
									tFee1="${fn:escapeXml(item.tFee1)}"
									tFeeTitle2="${fn:escapeXml(item.tFeeTitle2)}"
									tFee2="${fn:escapeXml(item.tFee2)}"
									tFeeTitle3="${fn:escapeXml(item.tFeeTitle3)}"
									tFee3="${fn:escapeXml(item.tFee3)}"
									tFeeTitle4="${fn:escapeXml(item.tFeeTitle4)}"
									tFee4="${fn:escapeXml(item.tFee4)}"
									iFeeTitle1="${fn:escapeXml(item.iFeeTitle1)}"
									iFee1="${fn:escapeXml(item.iFee1)}"
									iFeeTitle2="${fn:escapeXml(item.iFeeTitle2)}"
									iFee2="${fn:escapeXml(item.iFee2)}"
									iFeeTitle3="${fn:escapeXml(item.iFeeTitle3)}"
									iFee3="${fn:escapeXml(item.iFee3)}"
									iFeeTitle4="${fn:escapeXml(item.iFeeTitle4)}"
									iFee4="${fn:escapeXml(item.iFee4)}"
									/>
								</c:if>
							</td>
							<td>
							...
							<td>
								${item.iQuantity!=null?item.iQuantity:'&nbsp;'}<br/>
								（未发货数：${item.iQuantityNotSent!=null?item.iQuantityNotSent:'&nbsp;'}）
							</td>
						</tr>
					</c:forEach>
				</table>
